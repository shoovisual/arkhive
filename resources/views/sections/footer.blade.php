        ...
        <div class="container mx-auto px-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <h4 class="mt-6 font-[Garamond] uppercase text-2xl font-medium">It is not a priority, until it is.</h4>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 font-[Montserrat]">
                        <div class="phone mt-6 group flex items-center gap-4">
                            ...
                            <div class="number">
                                <p>Phone:</p>
                                <a class="group-hover:text-ark-brown" href="tel:+255712185393">+255 712 185 393</a>
                            </div>
                        </div>
                        <div class="phone mt-6 group flex items-center gap-4">
