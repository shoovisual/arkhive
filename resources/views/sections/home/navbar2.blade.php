    ...
    <div class="mx-auto px-5 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="cta-btn items-center hidden lg:flex gap-x-3">
                ...
                <a href="{{ route('contact') }}" class="relative regular-button bg-ark-black hover:bg-[#121212] font-[montserrat] w-fit group md:px-4 md:py-2 px-2 py-2 rounded-md border-ark-brown border text-white md:text-[18px] text-[14px] font-medium transition-all duration-300">
                    Get quote
                </a>
            ...
            <div class="navbar-right lg:hidden flex md:gap-x-[5em] gap-x-3 justify-center items-center">
                <!-- New Button for Submitting Brief -->
                <a href="{{ route('contact') }}" class="relative regular-button bg-ark-black hover:bg-[#121212] font-[montserrat] w-fit group md:px-6 md:py-3 px-3 py-2 rounded-md border-ark-brown border text-white md:text-lg text-[14px] font-medium transition-all duration-300">
                    Get quote
                </a>
