...
<div class="bg-ark-black/20 py-16">
    <div class="max-w-7xl mx-auto px-10">
        ...
        <div class="grid grid-cols-1 items-center anim-section md:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach($sectors['sectors'] as $sector)
                <div class="bg-ark-black border anim-child flex flex-col justify-center items-center cursor-pointer font-[Montserrat] border-ark-brown/10 p-6 rounded-lg shadow-md transition-transform hover:scale-105">
