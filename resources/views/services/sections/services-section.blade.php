  ...
  <div class="container px-0 lg:px-10 lg:flex lg:flex-row flex-col justify-center mx-auto">
    ...
    <div class="lg:w-1/2 w-full anim-section pr-8">
        <div class="lg:sticky lg:top-1/2 transform  py-4">
            ...
            <p class="text-xl  text-white font-[ubuntu]">
                We offer a range of services to help you manage your documents effectively and efficiently.
            </p>
            <div class="quote mt-3">
                <p class="text-[24px] leading-[1] italic text-white md:w-xl md:text-left">"When you need a document, how long does it take to find it? Our clients' audits and critical operations are made smooth and faster with effective access to their documents"</p>
                <p class="text-md mt-4 md:w-xl font-[ubuntu] text-white"><span class="font-bold">Neema,</span> <span> Operations Manager.</span></p>
            </div>
        </div>
    </div>
